...
Fork the following repo `https://github.com/rent-a-camel-idp/backstage-demo` to your organization.
...
Fork the following repo `https://github.com/rent-a-camel-idp/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/rent-a-camel-idp/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/rent-a-camel-idp/backstage-app-demo` to your organization.
